/**
 * Theme system for footer-wessel
 * 
...
function loadUserTheme(): ColorScheme {
  ...
  try {
    ...
    console.debug(`[footer-wessel-theme] Failed to load ${themePath}:`, error);
  }
...
export function applyColor(
  ...
  try {
    ...
    if (!warnedInvalidThemeColors.has(key)) {
      ...
      console.debug(`[footer-wessel-theme] Invalid theme color "${key}"; falling back to "text".`, error);
    }
